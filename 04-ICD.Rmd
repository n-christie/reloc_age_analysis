...
A column documenting which source file the definition originates from is also included to trace specific defintions back to the corresponding Socialstyrelsen document or table.
