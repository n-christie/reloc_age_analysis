...
The approach taken to matching the ICD codes for further classification begins with identifying matches to the actual code and code-ranges from the socialstrylsen data.
With the end aim to classify these diagnosis codes into
...
* The main diagnosis (hdia) is given as "C15-C26", which is the same as Diagnosis # 1 (dia1).  This pattern is most commonly seen in the data.
* subsequent diagnoses can be seen across the columns dia1:dia11.  Here we notice duplicates, presumably because there are multiple and unique diagnoses that fall within the range of "C76-C80".
